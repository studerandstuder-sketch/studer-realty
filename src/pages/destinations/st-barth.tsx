// src/pages/destinations/st-barth.tsx
...
export default function StBarthCityPage() {
  ...
  const requestLink = (id: string) => `/contact?ref=${encodeURIComponent(id)}&city=st-barth`;

  const hasSelection = stBarthSelection.length > 0;

  return (
    <>
      <Head>
        <title>St-Barth | Studer Realty</title>
        <meta
          name="description"
          content="St-Barth: ultra-premium lifestyle, privacy, and high-season rental optionality. Curated homes aligned with Live · Rent · Resell."
        />
      </Head>
    ...
    <source src="/video/Hero-StBarth.mp4" type="video/mp4" />
          ...
          <div className="heroVideoContent">
            <div className="container narrow">
              ...
              <h1 className="h1">St-Barth</h1>

              <p className="lead">
                Ultra-premium island lifestyle, privacy, and high-season demand.
                <strong> Live · Rent · Resell</strong>.
              </p>

              {/* Why St-Barth inside the video */}
              <div className="whyInline">
                <p>
                  St-Barth is a scarcity market where lifestyle and discretion are everything.
                  Value holds when the villa is positioned correctly: views, privacy, access,
                  and a hosting experience that feels effortless.
                </p>
                <p>
                  We focus on villas that work in real life: strong indoor-outdoor flow,
                  low-friction operations, and a clear rental premium when you are away.
                </p>
              </div>
        ...
        <section className="sectionAlt" id="selection">
          <div className="container">
            ...
            {hasSelection ? (
              <div ref={railRef} className="rail" role="list" aria-label="Curated St-Barth homes">
                {stBarthSelection.map((h) => {
              ...
              <div className="emptySelection">
                ...
                <div className="emptyText">
                  We share St-Barth opportunities privately after a short call.
                  Tell us your lifestyle goals, budget range, and timing and we will curate a shortlist.
                </div>
        ...
        <section className="section">
          <div className="container">
            <div className="sectionHeader">
              <h2 className="h2">How We Select in St-Barth</h2>
              <p className="muted">Views, privacy, access, and a clean hosting experience.</p>
            </div>
            ...
            <div className="iconGrid">
              ...
              <div className="iconItem">
                <div
                  ...
                  aria-hidden="true"
                />
                High-season rental optionality
              </div>
              <div className="iconItem">
                <div
                  className="iconBox"
        ...
        <section className="sectionAlt">
          <div className="container narrow">
            <h2 className="h2">Common Mistakes in St-Barth</h2>
            <p className="lead">Luxury markets still punish weak fundamentals.</p>

            <ul style={{ marginTop: 14, paddingLeft: 18 }}>
              <li>Overpaying for interiors while ignoring views and access</li>
              <li>Buying a villa that is high friction to operate</li>
              <li>No staff and maintenance plan for peak season execution</li>
              <li>Underestimating privacy and noise patterns</li>
              <li>No clear resale positioning from day one</li>
            </ul>

            <p className="quote" style={{ marginTop: 18 }}>
              In St-Barth, the best villas feel effortless to live in and effortless to rent.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container narrow">
            <h2 className="h2">Owning in St-Barth: The Reality</h2>
            <p className="lead">Lifestyle, discretion, and operations.</p>

            <ul style={{ marginTop: 14, paddingLeft: 18 }}>
              <li>Peak season performance depends on execution standards</li>
              <li>Scarcity protects value when fundamentals are right</li>
              <li>Operational teams matter: housekeeping, concierge, maintenance</li>
