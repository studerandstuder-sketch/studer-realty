...
export default function DubaiCityPage() {
  ...
  const requestLink = (id: string) => `/contact?ref=${encodeURIComponent(id)}&city=dubai`;

  const hasSelection = dubaiSelection.length > 0;

  return (
    <>
      <Head>
        <title>Dubai | Studer Realty</title>
        <meta
          name="description"
          content="Dubai: lifestyle, global connectivity, and rental optionality. Curated homes aligned with Live · Rent · Resell."
        />
      </Head>
  ...
  >
    <source src="/video/Hero-Dubai.mp4" type="video/mp4" />
  </video>
          ...
          <div className="heroVideoContent">
            <div className="container narrow">
              ...
              <h1 className="h1">Dubai</h1>

              <p className="lead">
                Global connectivity, modern lifestyle, and strong rental optionality.
                <strong> Live · Rent · Resell</strong>.
              </p>

              {/* Why Dubai inside the video */}
              <div className="whyInline">
                <p>
                  Dubai is a high-velocity market. Value comes from buying the right micro-location,
                  building quality, and a clear rental and resale story from day one.
                </p>
                <p>
                  We focus on homes that work in real life: view corridors, walkability, amenities,
                  and layouts that stay desirable while avoiding high-friction ownership.
                </p>
              </div>

              <div className="heroActions">
                <a className="btnPrimary" href="#selection">
                  View our Dubai selection
                </a>
                <Link className="btnGhost" href="/contact?city=dubai">
                  Private call
                </Link>
              </div>
        ...
        <section className="sectionAlt" id="selection">
          <div className="container">
            ...
            {hasSelection ? (
              <div ref={railRef} className="rail" role="list" aria-label="Curated Dubai homes">
                {dubaiSelection.map((h) => {
              ...
              <div className="emptySelection">
                ...
                <div className="emptyText">
                  We share Dubai opportunities privately after a short call.
                ...
                >
                  <Link className="btnPrimary" href="/contact?city=dubai">
        ...
        <section className="section">
          <div className="container">
            <div className="sectionHeader">
              <h2 className="h2">How We Select in Dubai</h2>
              <p className="muted">Micro-location, building quality, and clear optionality.</p>
            </div>
            ...
            <div className="iconGrid">
              <div className="iconItem">
                <div
                  ...
                  aria-hidden="true"
                />
                Micro-location and view corridors
              </div>
              <div className="iconItem">
                <div
                  className="iconBox"
              ...
              <div className="iconItem">
                <div
                  ...
                  aria-hidden="true"
                />
                Developer quality and governance
              </div>
              <div className="iconItem">
                <div
                  className="iconBox"
        ...
        <section className="sectionAlt">
          <div className="container narrow">
            <h2 className="h2">Common Mistakes in Dubai</h2>
            <p className="lead">Fast markets punish weak fundamentals.</p>

            <ul style={{ marginTop: 14, paddingLeft: 18 }}>
              <li>Buying a marketing story instead of a proven micro-location</li>
              <li>Ignoring developer quality and maintenance trajectory</li>
              <li>Assuming rental performance without a real execution plan</li>
              <li>Overpaying for finishes while missing the view corridor</li>
              <li>No clear resale plan and liquidity positioning</li>
            </ul>

            <p className="quote" style={{ marginTop: 18 }}>
              The best Dubai purchases feel obvious in daily use and obvious on resale.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container narrow">
            <h2 className="h2">Owning in Dubai: The Reality</h2>
            <p className="lead">Clarity and structure create freedom.</p>

            <ul style={{ marginTop: 14, paddingLeft: 18 }}>
              <li>Service charges and governance matter</li>
              <li>Quality is developer track record and maintenance rhythm</li>
              <li>Liquidity favors proven locations and view-driven units</li>
