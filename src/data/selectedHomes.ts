...
export const miamiSelection: Home[] = [
  ...
  {
    id: "miami-02",
    title: "New Build Modern — Shorecrest / Miami",
  ...
  {
    id: "miami-03",
    title: "Bay View Condo — North Bay Village / Miami",
...
city: "miami",
  ...
  {
    id: "miami-05",
    title: "Waterfront Villa — Normandy / Miami Beach",
...
export const brazilSelection: Home[] = [
  {
    id: "brazil-01",
    title: "Walk-to-Beach New Build — Geribá / Búzios",
...
{
  id: "brazil-03",
  title: "Ferradura Pool Villa - Búzios",
...
{
  id: "brazil-04",
  title: "Ferradura Sea-View Villa - Búzios",
